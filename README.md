...
```
Stanice 0-203-0-11721: denní maximum teploty >= 30 °C — posledních 3 epizod (místní čas):
1. 18.06.2026 – 29.06.2026  (délka 12 dní, max. teplota 38.9 °C)
2. 26.05.2026 – 27.05.2026  (délka 2 dny, max. teplota 31.3 °C)
3. 24.05.2026  (délka 1 den, max. teplota 30.1 °C)
```
